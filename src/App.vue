  ...
  <div class="float-sm-none">
    <v-app id="main">
      ...
      <!-- biodata -->
          ...
          <!-- experiences -->
          <keep-alive>
            <v-lazy v-model="isActive2" :options="{threshold: 1}" min-height="200" transition="fade-transition">
              <v-main>
                <experiences/>
              </v-main>
            </v-lazy>
          ...
          <!-- contact us -->
          <keep-alive>
            <v-lazy v-model="isActive3" :options="{threshold: 1}" min-height="200" transition="fade-transition">
              <v-main>
                <conctact/>
              </v-main>
            </v-lazy>
